...
emoji: "✏️"
type: "tech"
topics: [Convex, Nextjs, TypeScript, React]
published: false
...
![ホワイトボードに棒人間を描いた完成イメージ](/images/convex-whiteboard/image2.png)
...
![ダークモードでペンの線が背景に溶けてしまっている状態](/images/convex-whiteboard/image.png)
